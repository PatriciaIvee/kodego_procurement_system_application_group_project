...
import ph.kodego.victor.yu.leones.patricia.ivee.procurementsystemapplication.databinding.ActivityNavDrawerBinding
...
class NavDrawerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.nav_home_dashboard, R.id.nav_inventory_monitoring, R.id.nav_incoming_inventory_tracker
            ), drawerLayout
        )
